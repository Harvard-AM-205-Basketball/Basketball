...
\begin{figure}[H]
\center
\includegraphics[width=0.90\textwidth]{Camera3_SyncFrame02316.png}
\includegraphics[width=0.90\textwidth]{Camera3_Foreground02316.png}
\end{figure}
...
\begin{figure}[H]
\center
\includegraphics[width=0.95\textwidth]{synced_frames.png}
\end{figure}
...
\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{Camera3_calibration_visual.png}
\caption*{Camera 3 Visual Calibration}
\includegraphics[width=1.00\textwidth]{Camera7_calibration_visual.png}
\caption*{Camera 7 Visual Calibration}
\end{figure}

\begin{figure}[H]
\includegraphics[width=1.00\textwidth]{Camera2_calibration_visual.png}
\caption*{Camera 2 Visual Calibration}

\includegraphics[width=1.00\textwidth]{Camera8_calibration_visual.png}
\caption*{Camera 8 Visual Calibration}
\end{figure}

\begin{figure}[H]
\includegraphics[width=1.00\textwidth]{Camera4_calibration_visual.png}
\caption*{Camera 4 Visual Calibration}

\includegraphics[width=1.00\textwidth]{Camera6_calibration_visual.png}
\caption*{Camera 6 Visual Calibration}
\end{figure}

\begin{figure}[H]
\includegraphics[width=1.00\textwidth]{Camera1_calibration_visual.png}
...
\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{Camera3_calibration_numerical.png}
\caption*{Camera 3 Numerical Calibration}

\includegraphics[width=1.00\textwidth]{Camera4_calibration_numerical.png}
\caption*{Camera 4 Numerical Calibration}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{Camera6_calibration_numerical.png}
...
\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{BallTableau00880.png}
\caption*{Frame 880: About to Shoot}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{BallTableau00890.png}
\caption*{Frame 890': Releasing the Ball}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{BallTableau00900.png}
\caption*{Frame 900: Ball in Ascent}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{BallTableau00910.png}
\caption*{Frame 910: Ball near Apex}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{BallTableau00920.png}
\caption*{Frame 920: Ball in Descent}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{BallTableau00930.png}
\caption*{Frame 930: Approaching the Basket}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{BallTableau00936.png}
\caption*{Frame 936: Basket!}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=1.00\textwidth]{BallTableau00940.png}
